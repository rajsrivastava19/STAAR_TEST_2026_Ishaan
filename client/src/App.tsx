      ...
      {screen !== 'test' && screen !== 'login' && screen !== 'home' && (
        <header className="site-header" style={{ flexWrap: 'wrap', justifyContent: 'space-between', textAlign: 'left', minHeight: '180px', padding: '12px 32px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px', justifyContent: 'center' }}>
            <div className="title-badge" style={{ width: '180px', height: '180px', padding: '4px', overflow: 'hidden', background: '#3b8655', borderRadius: '50%', border: '8px solid #6ccb8e', boxShadow: '0 8px 16px rgba(0,0,0,0.3)' }}>
